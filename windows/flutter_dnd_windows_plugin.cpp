...
class FlutterDndWindowsPlugin : public flutter::Plugin {
 public:
...
void FlutterDndWindowsPlugin::RegisterWithRegistrar(
  ...
  auto channel =
      std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
          registrar->messenger(), "flutter_dnd_windows",
          &flutter::StandardMethodCodec::GetInstance());

  auto plugin = std::make_unique<FlutterDndWindowsPlugin>();
...
void FlutterDndWindowsPlugin::HandleMethodCall(
    const flutter::MethodCall<flutter::EncodableValue> &method_call,
    std::unique_ptr<flutter::MethodResult<flutter::EncodableValue>> result) {
